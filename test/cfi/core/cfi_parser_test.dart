  ...
  group('CFI Parser Tests', () {
    group('Valid CFI Parsing', () {
      ...
      test('Parse CFI with temporal offset', () {
        ...
        expect(structure.start, isNotNull);
        expect(structure.start.parts.length, equals(5));
        expect(structure.start.parts[4].offset, equals(3)); // offset is preserved with temporal
      ...
      test('Parse CFI with spatial offset', () {
        ...
        expect(structure.start, isNotNull);
        expect(structure.start.parts.length, equals(5));
        expect(structure.start.parts[4].offset, equals(20)); // spatial parsing consumes differently
      ...
      test('Parse CFI with text assertion', () {
        ...
        expect(structure.start, isNotNull);
        expect(structure.start.parts.length, equals(5));
        expect(structure.start.parts[4].offset, equals(3)); // offset is preserved with text assertion
    ...
    group('Edge Cases', () {
      ...
      test('CFI with large numbers', () {
        final structure = CFIParser.parse('epubcfi(/999999/888888!/777777/666666/555555:444444)');
      ...
      test('CFI with special characters in ID', () {
        final structure = CFIParser.parse('epubcfi(/6/4[id-with_special.chars123]!/4/10/2:3)');
    ...
    group('Performance Tests', () {
      test('Parse performance - simple CFI', () {
        ...
        print('Average parsing time for simple CFI: ${averageTime.toStringAsFixed(2)} μs');
      ...
      test('Parse performance - complex CFI', () {
        ...
        final averageTime = stopwatch.elapsedMicroseconds / iterations;
        print('Average parsing time for complex CFI: ${averageTime.toStringAsFixed(2)} μs');
      ...
      test('Parse performance - range CFI', () {
        ...
        final averageTime = stopwatch.elapsedMicroseconds / iterations;
        print('Average parsing time for range CFI: ${averageTime.toStringAsFixed(2)} μs');
    ...
    group('Structure Properties', () {
      ...
      test('CFI collapse', () {
        ...
        expect(collapsedStart.start.parts.length, equals(5)); // parent + start combined
        
        final collapsedEnd = structure.collapse(toEnd: true);
        expect(collapsedEnd.hasRange, isFalse);
        expect(collapsedEnd.start.parts.length, equals(5)); // parent + end combined
      });
